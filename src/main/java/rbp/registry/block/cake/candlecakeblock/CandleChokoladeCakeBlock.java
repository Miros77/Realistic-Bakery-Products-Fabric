//package rbp.registry.block.cake.candlecakeblock;
//
...
//
//public class CandleChokoladeCakeBlock extends CandleCakeBlock {
//    private ChokoladeCakeBlock cake;
//
//    protected CandleChokoladeCakeBlock(Block candle, ChokoladeCakeBlock cake, Settings settings) {
...
//            } else {
//                ActionResult actionResult = ((ChokoladeCakeBlock)cake).tryEat(world, blockPos, cake.getDefaultState(), playerEntity);
