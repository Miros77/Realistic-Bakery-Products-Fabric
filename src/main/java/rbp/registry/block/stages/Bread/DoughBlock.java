package rbp.registry.block.stages.Bread;
...
public class DoughBlock extends Block {
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (itemStack.getItem() == ModRegistry.IRON_KNIFE || itemStack.getItem() == ModRegistry.GOLDEN_KNIFE) {
            if (!world.isClient)  {
                ...
                if (i == 5) {
                    world.setBlockState(pos, (BlockState) ModRegistry.RAW_BREADBLOCK.getDefaultState(), 11);
                    return ActionResult.SUCCESS;
                }
            }
            return ActionResult.SUCCESS;
    ...
    static {
        ...
        LEVEL_TO_SHAPE = new VoxelShape[]{
                ...
                Block.createCuboidShape(2.0999999999999996, 0, 5.1, 13.8, 5, 10.9),
                Block.createCuboidShape(2.0999999999999996, 0, 5.1, 10.9, 5, 10.9),
                Block.createCuboidShape(2.0999999999999996, 0, 5.1, 10.9, 5, 10.9),
                Block.createCuboidShape(2.0999999999999996, 0, 5.1, 10.9, 5, 10.9)
        };
