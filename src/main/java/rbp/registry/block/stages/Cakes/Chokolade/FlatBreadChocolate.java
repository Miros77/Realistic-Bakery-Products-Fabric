package rbp.registry.block.stages.Cakes.Chokolade;
...
public class FlatBreadChocolate extends Block {

    public static final IntProperty LEVEL;
    public static final VoxelShape[] LEVEL_TO_SHAPE;
    public FlatBreadChocolate() {
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (itemStack.getItem() == ModRegistry.FLAT_CHOCOLATE.asItem()) {
        ...
        if (itemStack.getItem() == ModRegistry.CHOCOLATE_CREAM) {
            ...
            if (!world.isClient) {
                ...
                if (i == 3) {
                    world.setBlockState(pos, (BlockState) ModRegistry.RAW_CHOCOLATE_CAKE.getDefaultState());
                    if  (!player.abilities.creativeMode) {
                        itemStack4 = new ItemStack(Items.GLASS_BOTTLE);
                        itemStack.decrement(1);
                        if (itemStack.isEmpty()) {
        ...
        if (itemStack.getItem() == ModRegistry.DOUGH_BLOCK.asItem()) {
    ...
    //Cakes cream
        ...
        if (itemStack.getItem() == ModRegistry.CREAM) {
            ...
            if (!world.isClient) {
                ...
                int i = (Integer)state.get(LEVEL);
                if (i == 3) {
                    world.setBlockState(pos, (BlockState) ModRegistry.RAW_CAKE.getDefaultState());
                    if  (!player.abilities.creativeMode) {
                        itemStack4 = new ItemStack(Items.GLASS_BOTTLE);
                        itemStack.decrement(1);
                        if (itemStack.isEmpty()) {
        ...
        //cream
        if (itemStack.getItem() == ModRegistry.STRAWBERRY_CREAM) {

            if (!world.isClient) {
                ItemStack itemStack4;
                int i = (Integer)state.get(LEVEL);
                if (i == 3) {
                    world.setBlockState(pos, (BlockState) ModRegistry.RAW_STRAWBERRY_CAKE.getDefaultState());
                    if  (!player.abilities.creativeMode) {
                        itemStack4 = new ItemStack(Items.GLASS_BOTTLE);
                        itemStack.decrement(1);
                        if (itemStack.isEmpty()) {
