...
//=========================================Make Item, Block=========================================//
    ...
    public static final Item RAW_HONEY_CAKE_OLD = new Item(new Item.Settings().group(ModItems.REALISTIC_BAKERY_PRODUCTS).maxCount(1));
...
//=========================================Register Items, Block=========================================//
  ...
  //SHORTCAKE
        ...
        Registry.register(Registry.ITEM, new Identifier(Tutorial.MOD_ID, "raw_honey_cake_old"), RAW_HONEY_CAKE_OLD);
